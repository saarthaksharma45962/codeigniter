            ...
            <?php foreach ($data as $key) : ?>
              <tr>
                ...
                <td class="project-actions text-right">
                  <a class="btn btn-primary btn-sm" href="project_details/<?= $key['ID'] ?>">
                    <i class="fas fa-folder">
                    </i>
                    View
                  </a>
                  <a class="btn btn-info btn-sm" href="edit/<?= $key['ID'] ?>">
                    <i class="fas fa-pencil-alt">
                    </i>
                    Edit
                  </a>
                  <a class="btn btn-danger btn-sm" href="project_delete/<?= $key['ID'] ?>">
